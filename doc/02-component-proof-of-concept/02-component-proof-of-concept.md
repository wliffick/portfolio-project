...
When choosing my method, I factored in what interests me, what I want to do in the future, and which design I felt like would implement well. After consideration, I chose my first design, SecureMessage. This method encrypts and decrypts messages as well as storing the message and key. Far more advanced cryptography is used in the real world, but I think this is a good starting point to understand the basics of how it works. Encryption is used in most communication across the web, especially in today's world where technology has become so advanced. Obviously, my implementation right now is not secure and could be easily decrypted, but I am working on understanding the basics of encryption.
